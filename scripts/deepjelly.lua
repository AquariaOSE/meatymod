...
-- FG: changed to soft glow, with a few tweaks
...
function init(me)
	...
	v.l = createQuad("softglow-add", 13)
	quad_scale(v.l, 2, 2)
	quad_alpha(v.l, 0.55)
    quad_setBlendType(v.l, BLEND_ADD)
...
function songNote(me, note)
    ...
    quad_alpha(v.l, 0.9, 0.4)
    quad_scale(v.l, 2.7, 2.7, 0.4)
end
...
function update(me, dt)
	...
	if v.revertTimer > 0 then
		...
		if v.revertTimer < 0 then
            ...
            quad_alpha(v.l, 0.55, 1)
            quad_scale(v.l, 2, 2, 1.2)
		end
	end
